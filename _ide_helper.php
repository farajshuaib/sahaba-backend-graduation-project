 ...
 */
     ...
     */ 
        ...
        {
                        /** @var \LaravelLang\JsonFallbackHotfix\Translator $instance */
        ...
        public static function macro($name, $macro)
        {            //Method inherited from \Illuminate\Translation\Translator         
                        \LaravelLang\JsonFallbackHotfix\Translator::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {            //Method inherited from \Illuminate\Translation\Translator         
                        \LaravelLang\JsonFallbackHotfix\Translator::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {            //Method inherited from \Illuminate\Translation\Translator         
                        return \LaravelLang\JsonFallbackHotfix\Translator::hasMacro($name);
        }
                    /**
         * Flush the existing macros.
         *
        ...
        public static function flushMacros()
        {            //Method inherited from \Illuminate\Translation\Translator         
                        \LaravelLang\JsonFallbackHotfix\Translator::flushMacros();
        }
